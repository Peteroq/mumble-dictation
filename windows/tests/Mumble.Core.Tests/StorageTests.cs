...
{
    private readonly string _path = Path.Combine(Path.GetTempPath(), $"mumble-dict-{Guid.NewGuid():N}.txt");
...
{
    private readonly string _path = Path.Combine(Path.GetTempPath(), $"mumble-hist-{Guid.NewGuid():N}.jsonl");
...
{
    private readonly string _path = Path.Combine(Path.GetTempPath(), $"mumble-set-{Guid.NewGuid():N}.json");
